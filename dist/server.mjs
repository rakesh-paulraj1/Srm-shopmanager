...
app.prepare().then(() => {
    ...
    io.on("connection", (socket) => {
        ...
        socket.on("newpurchase", (room, purchaseData) => {
            try {
                ...
                const pendingOrder = Object.assign(Object.assign({}, order), { // Spread the QueueOrder properties
                    orderId, createdAt: new Date() });
        ...
        // Server-side handler
        socket.on('markOrderDone', async (room, completeData) => {
            try {
